<div class="app">
    <aside class="sidebar">
        ...
        <nav class="menu">
            ...
            <hr>
            <a href="admin-inq.php" class="menu-item"><span><svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
        ...
        <nav class="menu">
            <hr />
            <a href="admin-packages.php" class="menu-item"><span>
                    <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            ...
            <hr>
            <a href="admin-suppliers.php" class="menu-item">
                <span>
        ...
        <nav class="menu">
            ...
            <hr>
            <form id="logoutform" action="../util/admin_logout.php" method="POST">
                <a id="logout-link" onclick="myFunction()" class="menu-item">
                    <span>
                        <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
